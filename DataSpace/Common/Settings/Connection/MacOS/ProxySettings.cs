...
namespace DataSpace.Common.Settings.Connection.MacOS {
    ﻿using System;
    ...
    public class ProxySettings : IProxySettings, IProxySettingsRead {
        ...
        public void Delete() {
            ...
            AbstractProxyConfigSection StoredSection = (AbstractProxyConfigSection)Loader.GetSection(SectionName, typeof(AbstractProxyConfigSection));
            lock (_Lock) {
